...
function  u = sweepDist( u, dx, numSweeps)
    ...
    for cnt = 1: numSweeps
        ...
        iFirst =    0;
        iStart =    size( u,2);   iEnd   =   1; icntr = -1;
        jStart =    1;  jEnd   =   size( u,1 ); jcntr = 1;
        u   =   directionSweep( u, dx, dy, iFirst, iStart, iEnd, icntr, jStart, jEnd, jcntr );
    end
    toc;
end
